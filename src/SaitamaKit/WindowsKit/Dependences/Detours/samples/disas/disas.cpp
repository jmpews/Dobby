...
struct DETOUR_IA64_BUNDLE_DISASSExecuteMemoryManagerLE : public DETOUR_IA64_BUNDLE
{
  public:
                                 ...
                                 _In_opt_ PVOID pCode)
{
    ...
    DETOUR_IA64_BUNDLE_DISASSExecuteMemoryManagerLE *pb = *(DETOUR_IA64_BUNDLE_DISASSExecuteMemoryManagerLE **)pCode;
...
int WINAPI WinMain(HINSTANCE hinst, HINSTANCE hprev, LPSTR lpszCmdLine, int nCmdShow)
{
    ...
    for (;; pbTest += 16) {
        DETOUR_IA64_BUNDLE_DISASSExecuteMemoryManagerLE *pb = (DETOUR_IA64_BUNDLE_DISASSExecuteMemoryManagerLE *)pbTest;
    ...
    DETOUR_IA64_BUNDLE_DISASSExecuteMemoryManagerLE *pb = (DETOUR_IA64_BUNDLE_DISASSExecuteMemoryManagerLE *)pbTest;
    DETOUR_IA64_BUNDLE_DISASSExecuteMemoryManagerLE *pbBeg = pb;
    DWORD dwOld;
    ...
    printf("%p:\n", pb);
    DETOUR_IA64_BUNDLE_DISASSExecuteMemoryManagerLE *pbEnd = pb;
