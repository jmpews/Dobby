...
#include <IOKit/KeyboardKit/HotKeyAbstractInterface/HotKey.h>

using namespace KeyBoardKit::HotKeyKit;
using namespace std;

HotKey::HotKey(UINT fsModifiers, UINT vk, void (*func)()) : m_fsModifiers(fsModifiers), m_vk(vk), m_func(func) {}
