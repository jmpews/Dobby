...
#include <IOKit/KeyboardKit/HotKeyAbstractInterface/HotKeyManager.h>

using KeyBoardKit::HotKeyKit::HotKeyManager;
using KeyBoardKit::HotKeyKit::HotKeyIndentifier;

HotKeyManager::HotKeyManager(HWND associatedWindow) : m_associatedWindow(associatedWindow), m_nextHotKeyIdentifier(1) {}
