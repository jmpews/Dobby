...
void dynamic_context_begin_invocation_bridge_handler(RegisterContext *reg_ctx, DynamicClosureBridgeInfo *dcb_info);

void dynamic_context_end_invocation_bridge_handler(RegisterContext *reg_ctx, DynamicClosureBridgeInfo *dcb_info);
