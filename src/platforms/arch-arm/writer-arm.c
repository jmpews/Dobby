...
void zz_arm_writer_put_ldr_b_reg_address(ZzArmWriter *self, arm_reg reg,
                                         zaddr address)
{
...
{
    zz_arm_writer_put_sub_reg_reg_imm(self, ARM_REG_SP, ARM_REG_SP, 0x8);
    zz_arm_writer_put_str_reg_reg_imm(self, ARM_REG_R1, ARM_REG_SP, 0x0);
    zz_arm_writer_put_add_reg_reg_imm(self, ARM_REG_R1, ARM_REG_PC, 9);
    zz_arm_writer_put_str_reg_reg_imm(self, ARM_REG_R1, ARM_REG_SP, 0x4);
    zz_arm_writer_put_ldr_reg_reg_imm_index(self, ARM_REG_R1, ARM_REG_SP, 4, 0);
    zz_arm_writer_put_ldr_reg_reg_imm_index(self, ARM_REG_PC, ARM_REG_SP, 4, 0);
}
                                          ...
                                          arm_reg src_reg, zuint32 imm, zbool P, zbool U, zbool W)
{
    ...
    zz_arm_writer_put_instruction(self,
                                  0xe4100000 | rd.index << 12 | rs.index << 16 |
                                      P << 24 | U << 23 | W << 21 |
                                      (imm & ZZ_INT12_MASK));
}
void zz_arm_writer_put_ldr_reg_imm_literal(ZzArmWriter *self, arm_reg dst_reg,
                                           zint32 imm)
{
    ZzArmRegInfo rd;
    ...
    zz_arm_writer_put_instruction(
        self, 0xe51f0000 | U << 23 | rd.index << 12 | (ABS(imm) & ZZ_INT12_MASK));
}
                                       ...
                                       arm_reg src_reg, zint32 imm)
{
    ...
    if (imm >= 0)
        U = 1;
    zz_arm_writer_put_instruction(self,
                                  0xe4000000 | rd.index << 12 | rs.index << 16 |
                                      P << 24 | U << 23 | W << 21 |
                                      (imm & ZZ_INT12_MASK));
}
void zz_arm_writer_put_ldr_reg_address(ZzArmWriter *self, arm_reg reg,
                                       zaddr address)
{
    zz_arm_writer_put_ldr_reg_reg_imm(self, reg, ARM_REG_PC, -4);
    zz_arm_writer_put_bytes(self, (zpointer)&address, sizeof(zpointer));
}
                                       ...
                                       arm_reg src_reg, zuint32 imm)
{
    ...
    zz_arm_writer_put_instruction(self,
                                  0xe2800000 | rd.index << 12 | rs.index << 16 |
                                      (imm & ZZ_INT12_MASK));
}
                                       ...
                                       arm_reg src_reg, zuint32 imm)
{
    ...
    zz_arm_writer_put_instruction(self,
                                  0xe2400000 | rd.index << 12 | rs.index << 16 |
                                      (imm & ZZ_INT12_MASK));
}
...
{
    zz_arm_writer_put_instruction(self, 0xe320f000);
}
