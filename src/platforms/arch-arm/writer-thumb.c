...
void zz_thumb_writer_put_ldr_b_reg_address(ZzThumbAssemblerWriter *self, ZzARMReg reg,
                                           zz_addr_t address) {
    ZzARMRegInfo ri;
...
void
zz_thumb_writer_put_ldr_reg_address(ZzThumbAssemblerWriter *self, ZzARMReg reg, zz_addr_t address) {
    ZzARMRegInfo ri;
    zz_arm_register_describe(reg, &ri);
...
// A8.8.18
void
zz_thumb_writer_put_branch_imm(ZzThumbAssemblerWriter *self, uint32_t imm, bool link, bool thumb) {
    union {
        int32_t i;
        uint32_t u;
    } distance;
...
bool zz_thumb_writer_put_transfer_reg_reg_offset_T1(ZzThumbAssemblerWriter *self,
...
bool zz_thumb_writer_put_transfer_reg_reg_offset_T2(ZzThumbAssemblerWriter *self,
                                                    ZzThumbMemoryOperation operation,
                                                    ZzARMReg left_reg, ZzARMReg right_reg,
                                                    int32_t right_offset) {
    ZzARMRegInfo lr, rr;
...
bool zz_thumb_writer_put_transfer_reg_reg_offset_T3(ZzThumbAssemblerWriter *self,
                                                    ZzThumbMemoryOperation operation,
                                                    ZzARMReg left_reg, ZzARMReg right_reg,
                                                    int32_t right_offset) {
    ZzARMRegInfo lr, rr;
...
bool zz_thumb_writer_put_transfer_reg_reg_offset_T4(ZzThumbAssemblerWriter *self,
                                                    ZzThumbMemoryOperation operation,
                                                    ZzARMReg left_reg, ZzARMReg right_reg,
                                                    int32_t right_offset,
    ...
    if (ABS(right_offset) < (1 << 8)) {
        if (rr.meta == ZZ_ARM_REG_PC) {
            ...
            if (right_offset > 0)
                add = 1;
            zz_thumb_writer_put_instruction(self, 0xf840 |
                                                  ((operation == ZZ_THUMB_MEMORY_LOAD) ? 0x0010
                                                                                       : 0x0000) |
                                                  rr.index);
            zz_thumb_writer_put_instruction(self,
                                            0x0800 | (lr.index << 12) | (index << 10) | (add << 9) |
...
static void zz_thumb_writer_put_transfer_reg_reg_offset(ZzThumbAssemblerWriter *self,
                                                        ZzThumbMemoryOperation operation,
                                                        ZzARMReg left_reg, ZzARMReg right_reg,
                                                        int32_t right_offset) {
...
void zz_thumb_writer_put_ldr_reg_reg_offset(ZzThumbAssemblerWriter *self, ZzARMReg dst_reg,
                                            ZzARMReg src_reg,
                                            int32_t src_offset) {
...
void zz_thumb_writer_put_str_reg_reg_offset(ZzThumbAssemblerWriter *self, ZzARMReg src_reg,
                                            ZzARMReg dst_reg,
                                            int32_t dst_offset) {
...
void zz_thumb_writer_put_ldr_index_reg_reg_offset(ZzThumbAssemblerWriter *self, ZzARMReg dst_reg,
                                                  ZzARMReg src_reg,
...
void zz_thumb_writer_put_str_index_reg_reg_offset(ZzThumbAssemblerWriter *self, ZzARMReg src_reg,
                                                  ZzARMReg dst_reg,
...
void
zz_thumb_writer_put_str_reg_reg(ZzThumbAssemblerWriter *self, ZzARMReg src_reg, ZzARMReg dst_reg) {
    zz_thumb_writer_put_str_reg_reg_offset(self, src_reg, dst_reg, 0);
    return;
}

void
zz_thumb_writer_put_ldr_reg_reg(ZzThumbAssemblerWriter *self, ZzARMReg dst_reg, ZzARMReg src_reg) {
...
void zz_thumb_writer_put_add_reg_reg_imm(ZzThumbAssemblerWriter *self, ZzARMReg dst_reg,
                                         ZzARMReg left_reg,
                                         int32_t right_value) {
    ...
    if (dst.meta <= ZZ_ARM_REG_R7 && left.meta <= ZZ_ARM_REG_R7 && ABS(right_value) < (1 << 3)) {
        ...
        zz_thumb_writer_put_instruction(self, insn);
    } else if ((left.meta == ZZ_ARM_REG_SP || left.meta == ZZ_ARM_REG_PC) &&
               dst.meta <= ZZ_ARM_REG_R7 &&
...
void zz_thumb_writer_put_sub_reg_reg_imm(ZzThumbAssemblerWriter *self, ZzARMReg dst_reg,
                                         ZzARMReg left_reg,
                                         int32_t right_value) {
...
void zz_thumb_writer_put_add_reg_reg_reg(ZzThumbAssemblerWriter *self, ZzARMReg dst_reg,
                                         ZzARMReg left_reg, ZzARMReg right_reg) {
