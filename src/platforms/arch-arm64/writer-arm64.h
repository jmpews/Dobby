...
void zz_arm64_writer_put_ldr_br_b_reg_address(ZzArm64Writer *self,
                                              arm64_reg reg, zaddr address);

void zz_arm64_writer_put_b_cond_imm(ZzArm64Writer *self, arm64_cc cc,
                                    zsize imm);

void zz_arm64_writer_put_ldr_reg_reg_offset(ZzArm64Writer *self,
                                            arm64_reg dst_reg,
                                            arm64_reg src_reg,
                                            zsize src_offset);

void zz_arm64_writer_put_str_reg_reg_offset(ZzArm64Writer *self,
                                            arm64_reg src_reg,
                                            arm64_reg dst_reg,
                                            zsize dst_offset);

void zz_arm64_writer_put_sub_reg_reg_imm(ZzArm64Writer *self, arm64_reg dst_reg,
                                         arm64_reg left_reg, zsize right_value);

void zz_arm64_writer_put_add_reg_reg_imm(ZzArm64Writer *self, arm64_reg dst_reg,
                                         arm64_reg left_reg, zsize right_value);

void zz_arm64_writer_put_ldr_reg_imm(ZzArm64Writer *self, arm64_reg reg,
                                     zsize imm);
...
void zz_arm64_writer_put_bytes(ZzArm64Writer *self, zbyte *data,
                               zuint data_size);
