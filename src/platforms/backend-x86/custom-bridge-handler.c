...
void context_begin_invocation_bridge_handler(RegState *rs, ClosureBridgeData *cbd) { return; }

void context_end_invocation(RegState *rs, HookEntry *entry, void *nextHop) {}

void context_end_invocation_bridge_handler(RegState *rs, ClosureBridgeData *cbd) { return; }

void dynamic_binary_instrumentation_invocation(RegState *rs, HookEntry *entry, void *nextHop) {}

void dynamic_binary_instrumentationn_bridge_handler(RegState *rs, ClosureBridgeData *cbd) { return; }