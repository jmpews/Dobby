...
zboolzz_vm_protect_via_task(task_t task, const zaddr address, zsize size,
                            vm_prot_t page_prot);

zboolzz_vm_protect_as_executable_via_task(task_t task, const zaddr address,
                                          zsize size);

zboolzz_vm_protect_as_writable_via_task(task_t task, const zaddr address,
                                        zsize size);

zboolzz_vm_get_page_info_via_task(task_t task, const zaddr address,
