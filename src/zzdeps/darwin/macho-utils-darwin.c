...
zpointer zz_macho_get_symbol_via_name(struct mach_header_64 *header, const char *name) {
    ...
    struct segment_command_64 *seg_cmd_64 = zz_macho_get_segment_64_via_name((struct mach_header_64 *) header,
                                                                             (char *) "__TEXT");
    struct segment_command_64 *seg_cmd_64_linkedit = zz_macho_get_segment_64_via_name((struct mach_header_64 *) header,
                                                                                      (char *) "__LINKEDIT");
