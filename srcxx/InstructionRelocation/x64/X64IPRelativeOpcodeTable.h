...
void _DecodeOpEn_OI_8(InstrMnemonic *instr, addr_t p) {
  _DecodeOpEn_OI(instr, p);
}

void _DecodeOpEn_OI_16or32(InstrMnemonic *instr, addr_t p) {
  _DecodeOpEn_OI(instr, p);
}
...
void _DecodeOpEn_MI_8(InstrMnemonic *instr, addr_t p) {
  _DecodeOpEn_MI(instr, p);
}

void _DecodeOpEn_MI_16or32(InstrMnemonic *instr, addr_t p) {
  _DecodeOpEn_MI(instr, p);
}
...
#define _xDecodeOpEn_I 0, _DecodeOpEn_I
...
// Reg in the Opcode, and Immedite
#define _xDecodeOpEn_OI 0, _DecodeOpEn_OI
#define _xDecodeOpEn_OI_8 0, _DecodeOpEn_OI_8
#define _xDecodeOpEn_OI_16or32 0, _DecodeOpEn_OI_16or32

// Decode Segment Prefix
#define _xDecodeSegPrefix 0, _DecodePrefix

// Decode Register Mod Immedite
#define _xDecodeOpEn_RMI 0, _DecodeOpEn_RMI

// Decode Mod Immedite
#define _xDecodeOpEn_MI 0, _DecodeOpEn_MI
#define _xDecodeOpEn_MI_8 0, _DecodeOpEn_MI_8
#define _xDecodeOpEn_MI_16or32 0, _DecodeOpEn_MI_16or32

// Decode REX prefix
#define _xDecodeREXPrefix 0, _DecodePrefix

// Decode prefix
#define _xDecodePrefix 0, _DecodePrefix

// Decode Offset
#define _xDecodeOpEn_D 0, _DecodeOpEn_D

// http://ref.x86asm.net/coder.html#x04
const OpcodeDecodeItem OpcodeDecodeTable[257] = {
    {0x00, _xDecodeOpEn_RM},                    // ADD /r
    {0x01, OpSz_16or32, _xDecodeOpEn_RM}, // ADD /r
    {0x02, OpSz_8, _xDecodeOpEn_RM},            // ADD /r
    {0x03, OpSz_16or32, _xDecodeOpEn_RM}, // ADD /r
    {0x04, OpSz_8, _xDecodeOpEn_I},             // ADD ib
    {0x05, OpSz_16or32, _xDecodeOpEn_I},  // ADD iw
#ifdef DETOURS_X64
    {0x06, _InvalidCopy}, // Invalid
    {0x07, _InvalidCopy}, // Invalid
#else
    {0x06, OpSz_0, _xDecodeOpEn_ZO}, // PUSH
    {0x07, OpSz_0, _xDecodeOpEn_ZO}, // POP
#endif
    {0x08, OpSz_8, _xDecodeOpEn_MR},       // OR /r
    {0x09, OpSz_16or32, _xDecodeOpEn_MR},       // OR /r
...
#else
    {0x0E, OpSz_0, _xDecodeOpEn_ZO}, // PUSH
#endif
...
#else
    {0x16, OpSz_0, _xDecodeOpEn_ZO}, // PUSH
    {0x17, OpSz_0, _xDecodeOpEn_ZO}, // POP
#endif
...
#else
    {0x1E, OpSz_0, _xDecodeOpEn_ZO}, // PUSH
    {0x1F, OpSz_0, _xDecodeOpEn_ZO}, // POP
#endif
...
#else
    {0x27, OpSz_0, _xDecodeOpEn_ZO}, // DAA
#endif
...
#else
    {0x2F, OpSz_0, _xDecodeOpEn_ZO}, // DAS
#endif
...
#else
    {0x37, OpSz_0, _xDecodeOpEn_ZO}, // AAA
#endif
...
#else
    {0x3F, OpSz_0, _xDecodeOpEn_ZO}, // AAS
#endif
...
#else
    {0x60, OpSz_0, _xDecodeOpEn_ZO}, // PUSHAD
    {0x61, OpSz_0, _xDecodeOpEn_ZO}, // POPAD
    ...
    {0x6B, _xDecodeOpEn_RMI},        // IMUL /r ib
    {0x6C, OpSz_0, _xDecodeOpEn_ZO}, // INS
    {0x6D, OpSz_0, _xDecodeOpEn_ZO}, // INS
    {0x6E, OpSz_0, _xDecodeOpEn_ZO}, // OUTS/OUTSB
    {0x6F, OpSz_0, _xDecodeOpEn_ZO}, // OUTS/OUTSW
    ...
    {0x80, _xDecodeOpEn_MI_8},       // ADD/0 OR/1 ADC/2 SBB/3 AND/4 SUB/5 XOR/6 CMP/7 byte reg, immediate byte
    {0x81, _xDecodeOpEn_MI_16or32},  // ADD/0 OR/1 ADC/2 SBB/3 AND/4 SUB/5 XOR/6 CMP/7 byte reg, immediate word or dword
#ifdef DETOURS_X64
    {0x82, _InvalidCopy}, // Invalid
#else
    {0x82, _Unknown},                // MOV al,x
#endif
    {0x83, _xDecodeOpEn_MI_8},       // ADD/0 OR/1 ADC/2 SBB/3 AND/4 SUB/5 XOR/6 CMP/7 reg, immediate byte
    ...
    {0x90, OpSz_0, _xDecodeOpEn_ZO}, // NOP
    {0x91, OpSz_0, _xDecodeOpEn_ZO}, // XCHG
    {0x92, OpSz_0, _xDecodeOpEn_ZO}, // XCHG
    {0x93, OpSz_0, _xDecodeOpEn_ZO}, // XCHG
    {0x94, OpSz_0, _xDecodeOpEn_ZO}, // XCHG
    {0x95, OpSz_0, _xDecodeOpEn_ZO}, // XCHG
    {0x96, OpSz_0, _xDecodeOpEn_ZO}, // XCHG
    {0x97, OpSz_0, _xDecodeOpEn_ZO}, // XCHG
    {0x98, OpSz_0, _xDecodeOpEn_ZO}, // CWDE
    {0x99, OpSz_0, _xDecodeOpEn_ZO}, // CDQ
#ifdef DETOURS_X64
    {0x9A, _InvalidCopy}, // Invalid
#else
    {0x9A, _CopyBytes5Or7Dynamic},   // CALL cp
#endif
    {0x9B, OpSz_0, _xDecodeOpEn_ZO}, // WAIT/FWAIT
    {0x9C, OpSz_0, _xDecodeOpEn_ZO}, // PUSHFD
    {0x9D, OpSz_0, _xDecodeOpEn_ZO}, // POPFD
    {0x9E, OpSz_0, _xDecodeOpEn_ZO}, // SAHF
    {0x9F, OpSz_0, _xDecodeOpEn_ZO}, // LAHF
    {0xA0, _Unknwon},                // MOV
    {0xA1, _Unknwon},                // MOV
    {0xA2, _Unknwon},                // MOV
    {0xA3, _Unknwon},                // MOV
    {0xA4, OpSz_0, _xDecodeOpEn_ZO}, // MOVS
    {0xA5, OpSz_0, _xDecodeOpEn_ZO}, // MOVS/MOVSD
    {0xA6, OpSz_0, _xDecodeOpEn_ZO}, // CMPS/CMPSB
    {0xA7, OpSz_0, _xDecodeOpEn_ZO}, // CMPS/CMPSW
    {0xA8, _xDecodeOpEn_I_8},        // TEST
    {0xA9, _xDecodeOpEn_I_16or32},   // TEST
    {0xAA, OpSz_0, _xDecodeOpEn_ZO}, // STOS/STOSB
    {0xAB, OpSz_0, _xDecodeOpEn_ZO}, // STOS/STOSW
    {0xAC, OpSz_0, _xDecodeOpEn_ZO}, // LODS/LODSB
    {0xAD, OpSz_0, _xDecodeOpEn_ZO}, // LODS/LODSW
    {0xAE, OpSz_0, _xDecodeOpEn_ZO}, // SCAS/SCASB
    {0xAF, OpSz_0, _xDecodeOpEn_ZO}, // SCAS/SCASD
    {0xB0, _xDecodeOpEn_OI_8},       // MOV B0+rb
    {0xB1, _xDecodeOpEn_OI_8},       // MOV B0+rb
    {0xB2, _xDecodeOpEn_OI_8},       // MOV B0+rb
    {0xB3, _xDecodeOpEn_OI_8},       // MOV B0+rb
    {0xB4, _xDecodeOpEn_OI_8},       // MOV B0+rb
    {0xB5, _xDecodeOpEn_OI_8},       // MOV B0+rb
    {0xB6, _xDecodeOpEn_OI_8},       // MOV B0+rb
    {0xB7, _xDecodeOpEn_OI_8},       // MOV B0+rb
    {0xB8, _xDecodeOpEn_OI_16or32},  // MOV B8+rb
    {0xB9, _xDecodeOpEn_OI_16or32},  // MOV B8+rb
    {0xBA, _xDecodeOpEn_OI_16or32},  // MOV B8+rb
    {0xBB, _xDecodeOpEn_OI_16or32},  // MOV B8+rb
    {0xBC, _xDecodeOpEn_OI_16or32},  // MOV B8+rb
    {0xBD, _xDecodeOpEn_OI_16or32},  // MOV B8+rb
    {0xBE, _xDecodeOpEn_OI_16or32},  // MOV B8+rb
    {0xBF, _xDecodeOpEn_OI_16or32},  // MOV B8+rb
    {0xC0, OpSz_8, _xDecodeOpEn_MI}, // RCL/2 ib, etc.
    {0xC1, OpSz_8, _xDecodeOpEn_MI}, // RCL/2 ib, etc.
    {0xC2, OpSz_16, _xDecodeOpEn_I}, // RET
    {0xC3, OpSz_0, _xDecodeOpEn_ZO}, // RET
    {0xC4, _CopyVex3},               // LES, VEX 3-byte opcodes.
    {0xC5, _CopyVex2},               // LDS, VEX 2-byte opcodes.
    {0xC6, _Unknown},                // MOV
    {0xC7, _xDecodeOpEn_MI_16or32},  // MOV/0 XBEGIN/7
    {0xC8, _CopyBytes4},             // ENTER
    {0xC9, OpSz_0, _xDecodeOpEn_ZO}, // LEAVE
    ...
    {0xD7, OpSz_0, _xDecodeOpEn_ZO}, // XLAT/XLATB
    ...
    {0xEC, OpSz_0, _xDecodeOpEn_ZO}, // IN ib
    {0xED, OpSz_0, _xDecodeOpEn_ZO}, // IN id
    {0xEE, OpSz_0, _xDecodeOpEn_ZO}, // OUT
    {0xEF, OpSz_0, _xDecodeOpEn_ZO}, // OUT
    {0xF0, _xDecodePrefix},          // LOCK prefix
    ...
    {0xF3, _xDecodePrefix},          // REPE prefix
#endif
    {0xF4, OpSz_0, _xDecodeOpEn_ZO}, // HLT
    {0xF5, OpSz_0, _xDecodeOpEn_ZO}, // CMC
    {0xF6, _CopyF6},                 // TEST/0, DIV/6
    {0xF7, _CopyF7},                 // TEST/0, DIV/6
    {0xF8, OpSz_0, _xDecodeOpEn_ZO}, // CLC
    {0xF9, OpSz_0, _xDecodeOpEn_ZO}, // STC
    {0xFA, OpSz_0, _xDecodeOpEn_ZO}, // CLI
    {0xFB, OpSz_0, _xDecodeOpEn_ZO}, // STI
    {0xFC, OpSz_0, _xDecodeOpEn_ZO}, // CLD
    {0xFD, OpSz_0, _xDecodeOpEn_ZO}, // STD
