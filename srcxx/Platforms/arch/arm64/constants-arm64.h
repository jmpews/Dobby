...
#define OPT_W(op, attribute) op##_##attribute_w
#define OPT_X(op, attribute) op##_##attribute_x
#define OPT_S(op, attribute) op##_##attribute_s
#define OPT_D(op, attribute) op##_##attribute_d
#define OPT_Q(op, attribute) op##_##attribute_q
