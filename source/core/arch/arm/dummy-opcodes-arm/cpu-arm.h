...
#define ARM_EXT_V6_DSP                                                                                                 \
  0x04000000                   /* ARM v6 (DSP-related),                                                                \
             not in v7-M.  */
...
#define ARM_EXT_ADIV                                                                                                   \
  0x40000000                    /* Integer divide extensions in ARM                                                    \
             state.  */
...
#define ARM_AEXT_V6M           ((ARM_AEXT_V6K | ARM_AEXT_V6M_ONLY) & ~(ARM_AEXT_NOTM | ARM_EXT_OS))
...
#define FPU_VFP_HARD                                                                                                   \
  (FPU_VFP_EXT_V1xD | FPU_VFP_EXT_V1 | FPU_VFP_EXT_V2 | FPU_VFP_EXT_V3xD | FPU_VFP_EXT_FMA | FPU_NEON_EXT_FMA |        \
...
#define FPU_ARCH_CRYPTO_NEON_VFP_ARMV8_DOTPROD                                                                         \
  ARM_FEATURE_COPROC(FPU_CRYPTO_ARMV8 | FPU_NEON_ARMV8 | FPU_VFP_ARMV8 | FPU_NEON_EXT_DOTPROD)
...
#define FPU_ARCH_DOTPROD_NEON_VFP_ARMV8 ARM_FEATURE_COPROC(FPU_NEON_EXT_DOTPROD | FPU_NEON_ARMV8 | FPU_VFP_ARMV8)
...
#define ARM_ARCH_V8_4A                                                                                                 \
  ARM_FEATURE(ARM_AEXT_V8A, ARM_AEXT2_V8_4A, CRC_EXT_ARMV8 | FPU_NEON_EXT_RDMA | FPU_NEON_EXT_DOTPROD)
...
/* Extensions containing some Thumb-2 instructions.  If any is present, Thumb
   ISA is Thumb-2.  */
#define ARM_ARCH_THUMB2                                                                                                \
  ARM_FEATURE_CORE(ARM_EXT_V6T2 | ARM_EXT_V7 | ARM_EXT_DIV | ARM_EXT_V8, ARM_EXT2_ATOMICS | ARM_EXT2_V6T2_V8M)
/* v7-a+sec.  */
