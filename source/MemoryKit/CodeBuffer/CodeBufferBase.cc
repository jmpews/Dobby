...
void CodeBufferBase::Emit8(uint8_t value) {
  ...
  *reinterpret_cast<uint8_t *>(buffer_cursor_) = value;
  buffer_cursor_ += sizeof(uint8_t);
}
...
void CodeBufferBase::Emit16(uint16_t value) {
  ...
  *reinterpret_cast<uint16_t *>(buffer_cursor_) = value;
  buffer_cursor_ += sizeof(uint16_t);
}
...
void CodeBufferBase::Emit32(uint32_t value) {
  ...
  *reinterpret_cast<uint32_t *>(buffer_cursor_) = value;
  buffer_cursor_ += sizeof(uint32_t);
}
...
void CodeBufferBase::Emit64(uint64_t value) {
  ...
  *reinterpret_cast<uint64_t *>(buffer_cursor_) = value;
  buffer_cursor_ += sizeof(uint64_t);
}
...
void CodeBufferBase::EmitBuffer(void *buffer, int buffer_size) {
  ...
  _memcpy(buffer_cursor_, buffer, buffer_size);

  buffer_cursor_ += buffer_size;
}
...
template <typename T> void CodeBufferBase::Emit(T value) {
  ...
  *reinterpret_cast<T *>(buffer_cursor_) = value;
  buffer_cursor_ += sizeof(T);
}
#endif
