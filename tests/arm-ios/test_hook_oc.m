...
void objcMethod_pre_call(RegState *rs, ThreadStack *threadstack,
                         CallStack *callstack) {
    zpointer t = 0x1234;
...
void objcMethod_post_call(RegState *rs, ThreadStack *threadstack,
                          CallStack *callstack) {
...
+ (void)zzMethodSwizzlingHook {
    ...
    ZzBuildHook((void *)oriImp, NULL, NULL, objcMethod_pre_call,
                objcMethod_post_call);
